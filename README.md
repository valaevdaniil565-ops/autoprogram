...
```text
release/StartWorkLauncher-2.0.3.zip

Version `2.0.3` is packaged as a Windows 10 friendly portable folder. Keep the files together and run `StartWorkLauncher.exe` from inside the extracted folder.
```
