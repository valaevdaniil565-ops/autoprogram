...
```text
release/StartWorkLauncher-3.0.0.zip

Version `3.0.0` is packaged as a Windows 10 friendly portable folder. Keep the files together and run `StartWorkLauncher.exe` from inside the extracted folder.
```
